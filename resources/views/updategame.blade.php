    ...
    <div class="card-body">
        ...
        <form action="/updategame/{{ $games->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group" style="margin-top: -2em">
                <input type="text" class="form-control @error('title') is-invalid @enderror" value="{{ $games->title }}" name="title" id="title" required>
                @error('title')
            ...
            <div class="input-group" style="margin-top: 2em;margin-bottom: 2em">
                ...
                <input type="integer" class="form-control @error('price') is-invalid @enderror" placeholder="Price" name="price" id="price" value="{{ $games->price }}">
                @error('price')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="batas" style="margin-top: 2em;margin-bottom: 2em">
                <div class="input-group">
                    <textarea class="form-control @error('detail') is-invalid @enderror" placeholder="At least 10 character" id="detail" rows="3" name="detail" required>{{ $games->description }}</textarea>
                    @error('detail')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
